...
import com.suqir.wasaischedule.ui.schedule_import.exception.CheckCodeErrorException
...
import com.suqir.wasaischedule.ui.schedule_import.login_school.hust.MobileHub
import com.suqir.wasaischedule.ui.schedule_import.login_school.jlu.UIMS
import com.suqir.wasaischedule.ui.schedule_import.login_school.suda.SudaXK
...
//        }
    ...
    private suspend fun login() {
        ...
        when (viewModel.school) {
            ...
            "西北工业大学" -> {
                Toasty.info(requireActivity().applicationContext, "年份为学年的起始年，学期[秋、春、夏]分别对应[1、2、3]\n例如[2019-2020春] 选择[2019 2]", Toast.LENGTH_LONG).show()
