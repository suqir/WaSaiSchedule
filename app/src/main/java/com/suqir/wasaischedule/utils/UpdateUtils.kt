            ...
            try {
                ...
                if (!context.getPrefer().getBoolean("isInitTimeTable", false)) {
                    val timeList = ArrayList<TimeDetailBean>().apply {
                        ...
                        add(TimeDetailBean(2, "08:55", "09:40", 1))
                        add(TimeDetailBean(3, "10:00", "10:45", 1))
                        add(TimeDetailBean(4, "10:55", "11:40", 1))
                        add(TimeDetailBean(5, "14:00", "14:45", 1))
                        add(TimeDetailBean(6, "14:55", "15:40", 1))
                        add(TimeDetailBean(7, "16:00", "16:45", 1))
                        add(TimeDetailBean(8, "16:55", "17:40", 1))
                        add(TimeDetailBean(9, "18:50", "19:35", 1))
                        add(TimeDetailBean(10, "19:45", "20:30", 1))
                        add(TimeDetailBean(11, "00:00", "00:00", 1))
